<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <form action="{{ route('forum.store-post', $thread->slug) }}" method="POST" x-data="{ submitting: false }" x-on:submit="submitting = true">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea id="content" name="content" rows="10" required maxlength="10000" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="{{ __('forum.Write your reply...') }}">{{ old('content') }}</textarea>
                ...
                <div class="flex items-center justify-end gap-4">
                    ...
                    <button type="submit" :disabled="submitting" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                        <span x-show="!submitting">{{ __('forum.Post Reply') }}</span>
