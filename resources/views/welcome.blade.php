...
<body class="font-sans antialiased bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200">
    <!-- Navigation -->
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 shadow-sm transition-colors duration-200">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center gap-2 px-3 py-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium transition rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
                            <a href="{{ route('locale.switch', 'en') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition {{ app()->getLocale() === 'en' ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 font-semibold' : '' }}">
                            ...
                            <a href="{{ route('locale.switch', 'ar') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition {{ app()->getLocale() === 'ar' ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 font-semibold' : '' }}">
                                <div class="flex items-center gap-2">
                                    <span>🇸🇦</span>
                                    <span>العربية</span>
                                    @if(app()->getLocale() === 'ar')
                    ...
                    <a href="{{ route('login') }}" class="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium transition">{{ __('common.Sign In') }}</a>
                    <a href="{{ route('register') }}" class="px-4 py-2 bg-gradient-to-r from-slate-900 to-slate-800 dark:from-blue-600 dark:to-blue-700 text-white rounded-xl font-semibold hover:from-slate-800 hover:to-slate-700 dark:hover:from-blue-700 dark:hover:to-blue-800 transition shadow-md">
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="#features" class="px-8 py-4 bg-white/90 dark:bg-gray-800/90 text-slate-900 dark:text-white border-2 border-white/50 dark:border-gray-700/50 rounded-xl font-semibold text-lg hover:bg-white dark:hover:bg-gray-800 transition shadow-md backdrop-blur-sm">
    ...
    <!-- About Section -->
    <section class="py-20 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 transition-colors duration-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-8 md:p-12 transition-colors duration-200">
    ...
    <!-- Features Section -->
    <section id="features" class="py-20 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition overflow-hidden group">
                    <div class="relative h-48 mb-6 rounded-xl overflow-hidden">
                        ...
                        <div class="absolute bottom-4 left-4 w-14 h-14 bg-white/90 dark:bg-gray-800/90 rounded-xl flex items-center justify-center shadow-lg">
                            <svg class="w-7 h-7 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                            </svg>
                        </div>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('common.Easy Booking') }}</h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition overflow-hidden group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('common.Recorded Courses') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition overflow-hidden group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('common.Expert Teachers') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition overflow-hidden group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('common.Direct Messaging') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition overflow-hidden group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('common.Resources & Materials') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition overflow-hidden group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('common.Reviews & Ratings') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="text-center group">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('common.Sign Up') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('common.Create your free account in seconds. Choose your role as a student or teacher.') }}</p>
                </div>
                ...
                <div class="text-center group">
                    <div class="relative mb-6 mx-auto w-32 h-32 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-xl transition">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-br from-emerald-600/60 to-emerald-800/60 flex items-center justify-center">
                            <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center text-emerald-600 dark:text-emerald-400 text-2xl font-bold shadow-lg">
                                2
                            </div>
                        </div>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('common.Browse & Choose') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('common.Explore subjects, view teacher profiles, ratings, and available time slots.') }}</p>
                </div>
                ...
                <div class="text-center group">
                    <div class="relative mb-6 mx-auto w-32 h-32 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-xl transition">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-br from-purple-600/60 to-purple-800/60 flex items-center justify-center">
                            <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center text-purple-600 dark:text-purple-400 text-2xl font-bold shadow-lg">
                                3
                            </div>
                        </div>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('common.Book & Pay') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('common.Select your preferred time slot, complete secure payment, and confirm your booking.') }}</p>
                </div>
                ...
                <div class="text-center group">
                    <div class="relative mb-6 mx-auto w-32 h-32 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-xl transition">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-br from-amber-600/60 to-amber-800/60 flex items-center justify-center">
                            <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center text-amber-600 dark:text-amber-400 text-2xl font-bold shadow-lg">
                                4
                            </div>
                        </div>
                    </div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('common.Learn & Grow') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('common.Attend your session, access resources, and continue learning with recorded courses.') }}</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-10 h-10 bg-gradient-to-br from-slate-900 to-slate-800 dark:from-blue-600 dark:to-blue-800 rounded-xl flex items-center justify-center">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            </svg>
                        </div>
                        <span class="text-lg font-bold text-gray-900 dark:text-white">{{ __('common.Tutoring System') }}</span>
                    </div>
                ...
                <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-4">{{ __('common.Quick Links') }}</h3>
                    <ul class="space-y-2">
                        <li><a href="#features" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition">{{ __('common.Features') }}</a></li>
                        <li><a href="{{ route('register') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition">{{ __('common.Sign Up') }}</a></li>
                        <li><a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition">{{ __('common.Sign In') }}</a></li>
                    </ul>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white mb-4">{{ __('common.Support') }}</h3>
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition">{{ __('common.Help Center') }}</a></li>
                        <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition">{{ __('common.Contact Us') }}</a></li>
                        <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition">{{ __('common.Privacy Policy') }}</a></li>
                    </ul>
                </div>
            </div>
