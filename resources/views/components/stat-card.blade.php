...
<{{ $tag }}
    {{ $href ? "href={$href}" : '' }}
    {{ $attributes->merge(['class' => 'relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 p-6 shadow-sm ring-1 ring-gray-900/5 dark:ring-gray-700/50 transition-all duration-200 ' . ($href ? 'hover:shadow-md hover:ring-2 ' . $colorClasses['ring'] . ' cursor-pointer' : '')]) }}
>
    <div class="flex items-start justify-between">
        ...
        @if($icon)
        <div class="flex-shrink-0 rounded-lg {{ $colorClasses['bg'] }} p-3">
