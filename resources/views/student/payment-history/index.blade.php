    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('common.View all your payment transactions') }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/30 dark:to-emerald-800/30 rounded-xl shadow-lg border-2 border-emerald-200 dark:border-emerald-700/50 p-4">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ number_format($todayPaid, 2) }} BHD</p>
                </div>
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl shadow-lg border-2 border-blue-200 dark:border-blue-700/50 p-4">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ number_format($weekPaid, 2) }} BHD</p>
                </div>
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl shadow-lg border-2 border-purple-200 dark:border-purple-700/50 p-4">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ number_format($monthPaid, 2) }} BHD</p>
                </div>
                <div class="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/30 dark:to-amber-800/30 rounded-xl shadow-lg border-2 border-amber-200 dark:border-amber-700/50 p-4">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ number_format($yearPaid, 2) }} BHD</p>
                </div>
                <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/30 dark:to-indigo-800/30 rounded-xl shadow-lg border-2 border-indigo-200 dark:border-indigo-700/50 p-4">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ number_format($totalPaid, 2) }} BHD</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 mb-6 overflow-hidden">
                <div class="p-4">
                    <form method="GET" action="{{ route('student.payment-history.index') }}" class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
            ...
            @if($bookings->isEmpty())
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 p-12 text-center">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-500">{{ __('common.Your payment history will appear here once you make payments') }}</p>
                </div>
            @else
                <!-- Payments Table -->
                        ...
                        <table class="w-full">
                            <thead class="bg-slate-50 dark:bg-gray-700/50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">{{ __('common.Teacher') }}</th>
                            ...
                            <tbody class="divide-y divide-slate-200 dark:divide-gray-700">
                                @foreach($bookings as $booking)
                                    <tr class="hover:bg-slate-50 dark:hover:bg-gray-700/30 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $booking->teacher->user->name }}</p>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="{{ route('student.bookings.show', $booking) }}" class="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 text-sm font-semibold">
                                                {{ __('common.View') }}
                                            </a>
                                        </td>
                                    </tr>
