        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl shadow-lg border-2 border-emerald-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-emerald-700 uppercase tracking-wide mb-1">Total Paid</h3>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg border-2 border-blue-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-blue-700 uppercase tracking-wide mb-1">This Month</h3>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-lg border-2 border-purple-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-purple-700 uppercase tracking-wide mb-1">This Week</h3>
                ...
                <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl shadow-lg border-2 border-amber-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-amber-700 uppercase tracking-wide mb-1">Pending</h3>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Learning Hours</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Teachers</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">Avg Duration</p>
                            ...
                            @foreach($upcomingBookingsList as $booking)
                                <div class="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-transparent rounded-xl border border-blue-100 hover:border-blue-200 transition">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-600">Teacher: <span class="font-semibold">{{ $booking->teacher->user->name }}</span></p>
                                    </div>
