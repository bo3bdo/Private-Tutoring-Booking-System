    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">{{ __('common.Select a subject to find available teachers') }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if($subjects->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-12 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('common.No Subjects Available') }}</h3>
                    <p class="text-gray-600">{{ __('common.Check back later for new subjects.') }}</p>
                </div>
            @else
