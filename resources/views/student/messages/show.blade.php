            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 border-t border-slate-200 bg-white">
                    <form method="POST" action="{{ route('student.messages.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <textarea name="body" rows="3" required placeholder="Type your message..." class="w-full rounded-xl border-2 border-slate-200 px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 transition resize-none"></textarea>
                        </div>
                        <div class="mb-4">
