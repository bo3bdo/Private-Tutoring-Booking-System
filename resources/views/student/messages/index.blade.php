        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-emerald-600 to-purple-600 dark:from-blue-800 dark:via-emerald-800 dark:to-purple-800 p-8 mb-8">
            ...
            <div class="relative z-20 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-100 dark:text-gray-200 mt-2 drop-shadow-md">{{ __('common.Chat with your teachers') }}</p>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if($conversations->isEmpty())
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 p-12 text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-6">{{ __('common.Start a conversation with your teacher from a booking page') }}</p>
                    <a href="{{ route('student.bookings.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-emerald-700 transition shadow-lg hover:shadow-xl">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                        </svg>
                        {{ __('common.View Bookings') }}
                    </a>
                </div>
            @else
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="divide-y divide-slate-200 dark:divide-gray-700">
                        @foreach($conversations as $conversation)
                            ...
                            @endphp
                            <a href="{{ route('student.messages.show', $conversation) }}" class="block p-6 hover:bg-gradient-to-r hover:from-blue-50 hover:to-emerald-50 dark:hover:from-gray-700/50 dark:hover:to-gray-700/50 transition group">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between mb-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                @if($isTeacher)
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-300">
                                                        {{ __('common.Teacher') }}
                                                    </span>
                                                @endif
                                            </div>
