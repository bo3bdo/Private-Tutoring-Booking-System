    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">{{ __('common.Get help with your account and bookings') }}</p>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($tickets->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-12 text-center">
                    ...
                    <p class="text-gray-600 text-lg mb-2">{{ __('common.No support tickets yet') }}</p>
            ...
            @else
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 mb-6 p-4">
                    <form method="GET" action="{{ route('student.support-tickets.index') }}" class="flex gap-4">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="{{ __('common.Search tickets...') }}" class="flex-1 rounded-xl border-2 border-slate-200 px-4 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 transition">
