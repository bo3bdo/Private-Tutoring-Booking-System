        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if($enrollments->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-12 text-center">
                    ...
                    <p class="text-gray-500 mb-2">{{ __('common.You haven\'t enrolled in any courses yet.') }}</p>
                    <a href="{{ route('student.subjects.index') }}" class="text-blue-600 hover:text-blue-800 font-semibold">{{ __('common.Browse Courses') }}</a>
                </div>
            @else
                            ...
                            <div class="p-6">
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-sm font-semibold text-gray-700">{{ __('common.Progress') }}</span>
