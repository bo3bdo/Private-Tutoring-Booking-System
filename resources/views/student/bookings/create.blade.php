        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white rounded-xl border border-slate-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">Subject</p>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white rounded-xl border border-slate-200">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900">{{ $slot->start_at->diffInMinutes($slot->end_at) }} minutes</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                <div class="p-6 md:p-8">
                    <div class="mb-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Booking Preferences</h3>
                        <p class="text-sm text-gray-600">Select your preferred lesson mode and provide any additional notes</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('student.bookings.store') }}" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-3">
                                Lesson Mode <span class="text-red-500">*</span>
                            </label>
                                    ...
                                    <label class="relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:border-blue-300 hover:bg-blue-50 {{ old('lesson_mode') === 'online' ? 'border-blue-500 bg-blue-50' : 'border-slate-200' }}">
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Video call lesson</p>
                                            </div>
                                        </div>
                                        <div class="flex-shrink-0">
                                    ...
                                    <label class="relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:border-emerald-300 hover:bg-emerald-50 {{ old('lesson_mode') === 'in_person' ? 'border-emerald-500 bg-emerald-50' : 'border-slate-200' }}">
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500">Physical location</p>
                                            </div>
                                        </div>
                                        <div class="flex-shrink-0">
                        ...
                        <div id="online_fields" class="hidden">
                            <div class="bg-blue-50 border-l-4 border-blue-400 rounded-xl p-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-blue-900 mb-1">Meeting Link Information</p>
                                        <p class="text-sm text-blue-800">
                                            The meeting URL will be provided by your teacher after booking confirmation.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="in_person_fields" class="hidden">
                            <div class="bg-emerald-50 border-l-4 border-emerald-400 rounded-xl p-4">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-emerald-900 mb-1">Location Information</p>
                                        <p class="text-sm text-emerald-800">
                                            The meeting location will be determined by your teacher after booking confirmation.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="4" class="w-full rounded-xl border-2 border-slate-200 px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:border-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 transition resize-none" placeholder="Any special requests, learning goals, or notes for your teacher...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
