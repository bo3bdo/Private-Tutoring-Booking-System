<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            <a href="{{ url()->previous() }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition">
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-6">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('common.Review your booking details') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                        <div class="flex items-start gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white truncate">{{ $teacher->user->name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white truncate">{{ $subject->name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">{{ $slot->start_at->format('M j, Y') }}</p>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">{{ $slot->start_at->diffInMinutes($slot->end_at) }} {{ __('common.minutes') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Error Messages -->
            @if($errors->any())
                <div class="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 dark:border-red-600 rounded-xl p-4 shadow-sm">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 flex-1">
                            <h3 class="text-sm font-semibold text-red-800 dark:text-red-300 mb-2">{{ __('common.Please fix the following errors:') }}</h3>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 overflow-hidden">
                <div class="p-6 md:p-8">
                    <div class="mb-6">
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">{{ __('common.Booking Preferences') }}</h3>
                    ...
                    <form method="POST" action="{{ route('student.bookings.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                @if($teacher->supports_online)
                                    <label class="relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 {{ old('lesson_mode') === 'online' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-slate-200 dark:border-gray-600' }}">
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-900 dark:text-white">{{ __('common.Online') }}</p>
                                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('common.Video call lesson') }}</p>
                                            </div>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <div class="w-5 h-5 rounded-full border-2 {{ old('lesson_mode') === 'online' ? 'border-blue-500 bg-blue-500' : 'border-slate-300 dark:border-gray-500' }}">
                                ...
                                @if($teacher->supports_in_person)
                                    <label class="relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:border-emerald-300 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 {{ old('lesson_mode') === 'in_person' ? 'border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20' : 'border-slate-200 dark:border-gray-600' }}">
                                        ...
                                        <div class="flex items-center gap-3 flex-1">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-900 dark:text-white">{{ __('common.In Person') }}</p>
                                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('common.Physical location') }}</p>
                                            </div>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <div class="w-5 h-5 rounded-full border-2 {{ old('lesson_mode') === 'in_person' ? 'border-emerald-500 bg-emerald-500' : 'border-slate-300 dark:border-gray-500' }}">
                        ...
                        <div id="online_fields" class="hidden">
                            <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 dark:border-blue-600 rounded-xl p-4">
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-blue-400 dark:text-blue-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                                    </svg>
                                    <div>
                                        <p class="text-sm font-semibold text-blue-900 dark:text-blue-300 mb-1">{{ __('common.Meeting Link Information') }}</p>
                        ...
                        <div id="in_person_fields" class="hidden">
                            <div class="bg-emerald-50 dark:bg-emerald-900/20 border-l-4 border-emerald-400 dark:border-emerald-600 rounded-xl p-4">
                                <div class="flex items-start gap-3">
                                    <svg class="w-5 h-5 text-emerald-400 dark:text-emerald-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                                    </svg>
                                    <div>
                                        <p class="text-sm font-semibold text-emerald-900 dark:text-emerald-300 mb-1">{{ __('common.Location Information') }}</p>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 dark:text-white mb-3">
                                {{ __('common.Additional Notes') }} <span class="text-gray-400 dark:text-gray-500 font-normal">{{ __('common.(Optional)') }}</span>
                            </label>
                            <textarea name="notes" rows="4" class="w-full rounded-xl border-2 border-slate-200 dark:border-gray-600 px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 focus:border-slate-400 dark:focus:border-gray-500 focus:outline-none focus:ring-2 focus:ring-slate-400 dark:focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition resize-none" placeholder="{{ __('common.Any special requests, learning goals, or notes for your teacher...') }}">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <!-- Form Actions -->
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 pt-6 border-t border-slate-200 dark:border-gray-700">
