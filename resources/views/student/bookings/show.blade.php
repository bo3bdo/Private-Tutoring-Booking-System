                        ...
                        @else
                            <div class="p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-xl">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-yellow-900 mb-1">Meeting URL Pending</p>
                                        <p class="text-sm text-yellow-800">The meeting URL will be provided by your teacher. Please check back later.</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($booking->location)
                            <div class="space-y-4">
                                <div class="p-4 bg-emerald-50 border-l-4 border-emerald-400 rounded-xl">
                                    <div class="space-y-3">
                                        <div>
                                            <p class="text-xs font-medium text-emerald-700 uppercase tracking-wide mb-1">Location Name</p>
                                            <p class="text-sm font-bold text-emerald-900">{{ $booking->location->name }}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs font-medium text-emerald-700 uppercase tracking-wide mb-1">Address</p>
                                            <p class="text-sm text-emerald-900">{{ $booking->location->address }}</p>
                                        </div>
                                        @if($booking->location->map_url)
                                            <div>
                                                <p class="text-xs font-medium text-emerald-700 uppercase tracking-wide mb-2">Map Location</p>
                                        ...
                                        @if($booking->location->notes)
                                            <div class="pt-3 border-t border-emerald-200">
                                                <p class="text-xs font-medium text-emerald-700 uppercase tracking-wide mb-1">Additional Notes</p>
                        ...
                        @else
                            <div class="p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-xl">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-yellow-900 mb-1">Location Pending</p>
                                        <p class="text-sm text-yellow-800">The meeting location will be specified by your teacher. Please check back later.</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                            ...
                            @foreach($booking->histories as $history)
                                <div class="flex items-start gap-4 p-4 bg-slate-50 rounded-xl border-l-4 border-blue-500">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        @if($history->actor)
                                            <p class="text-xs text-gray-500 mt-1">By: {{ $history->actor->name }}</p>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
