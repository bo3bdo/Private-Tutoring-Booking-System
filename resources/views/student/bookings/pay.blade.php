                ...
                <div class="p-6">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Review your booking details before payment</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                <div class="p-6 md:p-8">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-600">Choose your preferred payment gateway</p>
                    </div>
                        ...
                        @if(app()->environment('local') || config('app.debug'))
                            ...
                            <div class="relative my-4">
                                ...
                                <div class="relative flex justify-center text-sm">
                                    <span class="px-3 bg-white text-gray-500 font-medium">Or use real payment gateways</span>
                                </div>
                            </div>
                        @endif
