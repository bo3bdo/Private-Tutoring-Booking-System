<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('teacher.support-tickets.create') }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 dark:bg-emerald-700 text-white rounded-xl text-sm font-semibold hover:bg-emerald-700 dark:hover:bg-emerald-600 transition">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($tickets->isEmpty())
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 p-12 text-center">
                    ...
                    <a href="{{ route('teacher.support-tickets.create') }}" class="inline-flex items-center px-6 py-3 bg-emerald-600 dark:bg-emerald-700 text-white rounded-xl text-sm font-semibold hover:bg-emerald-700 dark:hover:bg-emerald-600 transition">
            ...
            @else
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 mb-6 p-4">
                    <form method="GET" action="{{ route('teacher.support-tickets.index') }}" class="flex gap-4">
                        ...
                        @if(request()->has('search'))
                            <a href="{{ route('teacher.support-tickets.index', ['status' => request('status')]) }}" class="px-4 py-2 border-2 border-slate-300 dark:border-gray-600 rounded-xl text-sm font-semibold text-slate-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-slate-50 dark:hover:bg-gray-700 transition">
                                Clear
                            </a>
                        @endif
                    </form>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-slate-200 dark:border-gray-700 overflow-hidden hover:shadow-xl transition">
                            <div class="p-6">
                                <div class="flex items-start justify-between gap-4">
                                    ...
                                    <a href="{{ route('teacher.support-tickets.show', $ticket) }}" class="flex-shrink-0 text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300">
