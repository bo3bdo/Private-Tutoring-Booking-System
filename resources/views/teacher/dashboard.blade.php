        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-600 p-8 mb-8">
            ...
            <div class="relative z-20 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-100 mt-2 drop-shadow-md">{{ __('common.Manage your teaching schedule and bookings') }}</p>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl shadow-lg border-2 border-emerald-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-emerald-700 uppercase tracking-wide mb-1">{{ __("common.Today's Earnings") }}</h3>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg border-2 border-blue-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-blue-700 uppercase tracking-wide mb-1">{{ __('common.This Week') }}</h3>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-lg border-2 border-purple-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-purple-700 uppercase tracking-wide mb-1">{{ __('common.This Month') }}</h3>
                ...
                <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl shadow-lg border-2 border-amber-200 p-6">
                    ...
                    <h3 class="text-sm font-semibold text-amber-700 uppercase tracking-wide mb-1">{{ __('common.Total Earnings') }}</h3>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">{{ __('common.Active Students') }}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">{{ __('common.Attendance Rate') }}</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">{{ __('common.Avg Booking Value') }}</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">{{ __('common.Pending Payments') }}</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">{{ __('common.Teaching Hours') }}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide">{{ __('common.Monthly Growth') }}</p>
                            ...
                            @foreach($upcomingBookings as $booking)
                                <div class="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-transparent rounded-xl border border-blue-100 hover:border-blue-200 transition">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-600">{{ __('common.Student') }}: <span class="font-semibold">{{ $booking->student->name }}</span></p>
                                    </div>
