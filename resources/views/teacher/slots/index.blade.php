            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-semibold text-gray-900">{{ __('common.Generate Slots') }}</h3>
                    </div>
                    <form method="POST" action="{{ route('teacher.slots.generate') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        @csrf
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.Start Date') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.End Date') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.Duration (min)') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.Subject (Optional)') }}</label>
