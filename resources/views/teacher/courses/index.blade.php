                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('common.Course') }}</th>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('common.Lessons') }}</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('common.Enrollments') }}</th>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-right text-sm font-medium">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="{{ route('teacher.courses.show', $course) }}" class="text-blue-600 hover:text-blue-900">{{ __('common.View') }}</a>
                                                <a href="{{ route('teacher.courses.edit', $course) }}" class="text-indigo-600 hover:text-indigo-900">{{ __('common.Edit') }}</a>
                                                <a href="{{ route('teacher.courses.lessons', $course) }}" class="text-purple-600 hover:text-purple-900">{{ __('common.Lessons') }}</a>
                                                <a href="{{ route('teacher.courses.sales', $course) }}" class="text-emerald-600 hover:text-emerald-900">{{ __('common.Sales') }}</a>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-6 py-12 text-center">
                                            <p class="text-gray-500">{{ __('common.No courses yet.') }} <a href="{{ route('teacher.courses.create') }}" class="text-blue-600 hover:text-blue-800 font-semibold">{{ __('common.Create one') }}</a></p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
