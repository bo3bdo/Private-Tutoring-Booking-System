    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div class="p-6">
                        ...
                        @if($booking->meeting_url)
                            <div class="mb-4 p-4 bg-blue-50 border-l-4 border-blue-400 rounded-xl">
                                <p class="text-sm font-semibold text-blue-900 mb-1">{{ __('common.Current Meeting Link:') }}</p>
                    ...
                    <div class="p-6">
                        ...
                        @if($booking->location)
                            <div class="mb-4 p-4 bg-emerald-50 border-l-4 border-emerald-400 rounded-xl">
                                <p class="text-sm font-semibold text-emerald-900 mb-1">{{ __('common.Current Location:') }}</p>
                        ...
                        @else
                            <div class="mb-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-xl">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-semibold text-yellow-900 mb-1">{{ __('common.Location Not Set') }}</p>
                                        <p class="text-sm text-yellow-800">{{ __('common.Please set the meeting location for this in-person lesson.') }}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
            ...
            @if($booking->isConfirmed())
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-4">{{ __('common.Actions') }}</h3>
