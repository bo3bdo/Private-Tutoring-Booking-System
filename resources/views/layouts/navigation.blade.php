        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->user()->isAdmin() ? route('admin.dashboard') : (auth()->user()->isTeacher() ? route('teacher.dashboard') : route('student.subjects.index')) }}" class="flex items-center gap-3">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        <x-nav-link :href="route('student.subjects.index')" :active="request()->routeIs('student.*')">
                            {{ __('Subjects') }}
                        </x-nav-link>
