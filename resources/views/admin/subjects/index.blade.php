<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.subjects.create') }}" class="rounded-xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('common.Teachers') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-2">
                                                <a href="{{ route('admin.subjects.show', $subject) }}" class="text-blue-600 hover:text-blue-900">{{ __('common.View') }}</a>
                                                <a href="{{ route('admin.subjects.edit', $subject) }}" class="text-indigo-600 hover:text-indigo-900">{{ __('common.Edit') }}</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                            {{ __('common.No subjects found.') }} <a href="{{ route('admin.subjects.create') }}" class="text-blue-600 hover:text-blue-800">{{ __('common.Create one') }}</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
