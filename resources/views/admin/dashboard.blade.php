<x-app-layout>
    <x-slot name="header">
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 p-8 mb-8">
            <!-- Background Image -->
            <div class="absolute inset-0 z-0">
                <div class="absolute inset-0 bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-slate-900/90 z-10"></div>
                <div class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80')] bg-cover bg-center bg-no-repeat"></div>
            </div>
            ...
            <div class="relative z-20 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-100 mt-2 drop-shadow-md">{{ __('common.Overview of your tutoring platform') }}</p>
                </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg border-2 border-blue-200 p-6">
                    ...
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-1">{{ __('common.Total Bookings') }}</p>
                ...
                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg border-2 border-yellow-200 p-6">
                    ...
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-1">{{ __('common.Pending Payments') }}</p>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl shadow-lg border-2 border-emerald-200 p-6">
                    ...
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-1">{{ __('common.Active Teachers') }}</p>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl shadow-lg border-2 border-purple-200 p-6">
                    ...
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-1">{{ __('common.Active Students') }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                <div class="p-6 border-b border-slate-200">
                    <h3 class="text-lg font-bold text-gray-900">{{ __('common.Quick Actions') }}</h3>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <a href="{{ route('admin.subjects.index') }}" class="group flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-transparent rounded-xl border-2 border-blue-200 hover:border-blue-300 hover:shadow-md transition">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 group-hover:text-blue-700 transition">{{ __('common.Manage Subjects') }}</p>
                                <p class="text-sm text-gray-600 mt-1">{{ __('common.Add, edit, or delete subjects') }}</p>
                            </div>
                        ...
                        <a href="{{ route('admin.locations.index') }}" class="group flex items-center gap-4 p-4 bg-gradient-to-r from-emerald-50 to-transparent rounded-xl border-2 border-emerald-200 hover:border-emerald-300 hover:shadow-md transition">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 group-hover:text-emerald-700 transition">{{ __('common.Manage Locations') }}</p>
                                <p class="text-sm text-gray-600 mt-1">{{ __('common.Add, edit, or delete locations') }}</p>
                            </div>
                        ...
                        <a href="{{ route('admin.teachers.index') }}" class="group flex items-center gap-4 p-4 bg-gradient-to-r from-indigo-50 to-transparent rounded-xl border-2 border-indigo-200 hover:border-indigo-300 hover:shadow-md transition">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 group-hover:text-indigo-700 transition">{{ __('common.Manage Teachers') }}</p>
                                <p class="text-sm text-gray-600 mt-1">{{ __('common.Add, edit, or delete teachers') }}</p>
                            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                <div class="p-6 border-b border-slate-200">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-bold text-gray-900">{{ __('common.Recent Bookings') }}</h3>
                    </div>
                </div>
                <div class="p-6">
                    @if($recentBookings->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500">{{ __('common.No recent bookings.') }}</p>
                        </div>
                    @else
                        <div class="space-y-4">
