    ...
    <div class="py-4 sm:py-6 lg:py-8 -mt-4 sm:-mt-6 lg:-mt-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 sm:space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <a href="{{ route('admin.bookings.index') }}" class="block bg-blue-50 dark:bg-blue-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-blue-200 dark:border-blue-700/50 p-4 sm:p-6 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['total_bookings'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.payments.index') }}" class="block bg-yellow-50 dark:bg-yellow-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-yellow-200 dark:border-yellow-700/50 p-4 sm:p-6 hover:border-yellow-300 dark:hover:border-yellow-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Pending Payments') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['pending_payments'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.teachers.index') }}" class="block bg-emerald-50 dark:bg-emerald-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-emerald-200 dark:border-emerald-700/50 p-4 sm:p-6 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Active Teachers') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['active_teachers'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.students.index') }}" class="block bg-purple-50 dark:bg-purple-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-purple-200 dark:border-purple-700/50 p-4 sm:p-6 hover:border-purple-300 dark:hover:border-purple-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Active Students') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['active_students'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <a href="{{ route('admin.payments.index', ['filter' => 'succeeded']) }}" class="block bg-green-50 dark:bg-green-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-green-200 dark:border-green-700/50 p-4 sm:p-6 hover:border-green-300 dark:hover:border-green-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Total Revenue') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($stats['total_revenue'], 2) }} BHD</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-green-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.courses.index') }}" class="block bg-indigo-50 dark:bg-indigo-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-indigo-200 dark:border-indigo-700/50 p-4 sm:p-6 hover:border-indigo-300 dark:hover:border-indigo-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Total Courses') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['total_courses'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.reviews.index') }}" class="block bg-orange-50 dark:bg-orange-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-orange-200 dark:border-orange-700/50 p-4 sm:p-6 hover:border-orange-300 dark:hover:border-orange-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Pending Reviews') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['pending_reviews'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-orange-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg>
                        </div>
                    </div>
                </a>

                <a href="{{ route('admin.support-tickets.index') }}" class="block bg-red-50 dark:bg-red-900/30 rounded-xl sm:rounded-2xl shadow-lg border-2 border-red-200 dark:border-red-700/50 p-4 sm:p-6 hover:border-red-300 dark:hover:border-red-600 hover:shadow-xl transition group">
                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                        <div class="space-y-1 flex-1">
                            <p class="text-xs sm:text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('common.Support Tickets') }}</p>
                            <p class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{{ $stats['open_support_tickets'] }}</p>
                        </div>
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-red-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition flex-shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <x-chart-card 
                    title="{{ __('common.Revenue Chart') }}"
                    description="{{ __('common.Daily revenue for the current month') }}"
                ...
                <x-chart-card 
                    title="{{ __('common.Booking Status Distribution') }}"
                    description="{{ __('common.Overview of booking statuses') }}"
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (revenueCtx) {
                    const revenueData = @json($revenueReport['daily_data']);
                ...
                if (bookingStatusCtx) {
                    const bookingStatus = @json($bookingsByStatus);
                    const labels = Object.keys(bookingStatus);
                    const data = Object.values(bookingStatus);
                        ...
                        data: {
                            labels: labels.map(l => {
                                ...
                                const statusMap = {
                                    ...
                                    'rescheduled': '{{ __("common.Rescheduled") }}'
                                };
                                return statusMap[l] || capitalized;
                            }),
                            datasets: [{
                                data: data,
                                backgroundColor: labels.map(l => colors[l] || 'rgb(107, 114, 128)'),
                                borderColor: '#fff',
                                borderWidth: 2
                            }]
                        },
