    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Approve or reject user reviews</p>
            </div>
        </div>
    </x-slot>
                            ...
                            <div class="p-6">
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 mb-2">By: <span class="font-semibold">{{ $review->user->name }}</span></p>
                                        @if($review->comment)
