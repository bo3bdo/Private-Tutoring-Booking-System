    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">{{ __('common.Manage customer support requests') }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 mb-6 p-4">
                <form method="GET" action="{{ route('admin.support-tickets.index') }}" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">{{ __('common.Status') }}</label>
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">{{ __('common.Priority') }}</label>
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">{{ __('common.Assigned To') }}</label>
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">{{ __('common.Search') }}</label>
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="{{ __('common.Search') }}..." class="w-full rounded-xl border-2 border-slate-200 px-3 py-2 text-sm">
                        </div>
                    </div>
            ...
            @if($tickets->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-12 text-center">
                    ...
                    <p class="text-gray-600 text-lg">{{ __('common.No support tickets found') }}</p>
                </div>
            @else
                <div class="space-y-4">
