        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.achievements.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('Unique identifier (e.g., first-booking)') }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="points" name="points" type="number" min="0" class="mt-1 block w-full" :value="old('points', 10)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="threshold" name="threshold" type="number" min="1" class="mt-1 block w-full" :value="old('threshold', 1)" required />
                                <x-input-error class="mt-2" :messages="$errors->get('threshold')" />
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('Number required to unlock') }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center mt-1 space-x-2">
                                    <input type="color" id="color" name="color" value="{{ old('color', '#3B82F6') }}" class="h-10 w-20 rounded border-gray-300 dark:border-gray-700">
                                    <x-text-input type="text" name="color_text" :value="old('color', '#3B82F6')" class="w-full" placeholder="#3B82F6" />
                                </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="icon" name="icon" type="text" class="mt-1 block w-full" :value="old('icon')" placeholder="trophy" />
