<x-guest-layout>
    <div class="space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-white drop-shadow-lg">Create Your Account</h2>
            <p class="mt-2 text-sm text-gray-100 drop-shadow-md">Join our platform and start your learning journey today</p>
        </div>
