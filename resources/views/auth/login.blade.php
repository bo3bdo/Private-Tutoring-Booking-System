<x-guest-layout>
    <div class="space-y-8">
            ...
            <div class="text-center">
                ...
                <h2 class="text-3xl font-bold text-white drop-shadow-lg">{{ __('Welcome Back') }}</h2>
                <p class="mt-2 text-sm text-gray-100 drop-shadow-md">{{ __('Sign in to your account to continue') }}</p>
            </div>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8">
                <form method="POST" action="{{ route('login') }}" class="space-y-6" x-data="{ submitting: false }" x-on:submit="submitting = true">
                    @csrf
                    ...
                    <div class="flex items-center justify-between">
                        <label for="remember_me" class="flex items-center cursor-pointer">
                            ...
                            <span class="ml-2 rtl:mr-2 rtl:ml-0 text-sm text-gray-600">{{ __('Remember me') }}</span>
                        </label>
                ...
                @if (app()->environment('local') || config('app.debug'))
                    <div class="mt-8 pt-8 border-t border-slate-200">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-4 text-center">{{ __('Development Mode') }}</p>
                        <div class="space-y-2">
