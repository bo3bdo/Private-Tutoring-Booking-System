...
Route::middleware(['auth', 'role:student'])->prefix('student')->name('student.')->group(function () {
    ...
    Route::post('/bookings/{booking}/validate-discount', [StudentBookingController::class, 'validateDiscount'])->name('bookings.validate-discount')->middleware('throttle:10,1');
    ...
    Route::post('/courses/{course}/validate-discount', [\App\Http\Controllers\Student\CourseController::class, 'validateDiscount'])->name('courses.validate-discount')->middleware('throttle:10,1');
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/users/load-more', [\App\Http\Controllers\Admin\UserController::class, 'loadMore'])->name('users.load-more');
